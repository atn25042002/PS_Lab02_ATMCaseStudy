...
public class BankDatabaseTest extends TestCase
{
    ...
    public void testCredit_Test36(){
        int userAccountNumber= 12345;
        //Comprobando saldo total despu�s de un dep�sito
        double amount = 200;
